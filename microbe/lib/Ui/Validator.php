 ...
 */
class Ui_Validator extends Zend_Validate_Abstract{
	...
	public function isValid($value){
		if (strlen(trim($value)) < $this->minLength) {
			$this->_error( "{$this->field}: value '{$value}' must be at least composed by " .$this->minLength. " characters" );
